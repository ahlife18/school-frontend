    ...
    <div style={{ fontFamily: 'Segoe UI, Arial, sans-serif' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        {filteredStudents.map((student) => {
          ...
          const statusColor = todayStatus === 'present' ? '#d4edda' : 
                              todayStatus === 'absent' ? '#f8d7da' : '#f9f9f9';
          const statusTextColor = todayStatus === 'present' ? '#155724' : 
                                  todayStatus === 'absent' ? '#721c24' : '#666';
          ...
          return (
            <div 
              ...
              style={{
                ...
                borderLeft: `6px solid ${todayStatus === 'present' ? '#28a745' : todayStatus === 'absent' ? '#dc3545' : '#6c757d'}`,
                display: 'flex',
            ...
            >
              ...
              {/* Row 2: Attendance Status + Delete */}
              <div style={{ 
                display: 'flex', 
                justifyContent: 'space-between', 
                alignItems: 'center', 
              ...
              {/* Row 3: Attendance History (if exists) */}
